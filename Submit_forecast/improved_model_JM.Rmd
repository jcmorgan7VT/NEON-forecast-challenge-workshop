...
#seperate training and test data (in the case of forecasts, test data is unknown)
#trying again
...
my_model |> 
  ...
  autoplot(level = 95) + 
  geom_line(data =  filter(btrain, datetime > "2023-04-01"), aes(x = datetime, y = observation))+
